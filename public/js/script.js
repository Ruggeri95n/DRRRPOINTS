...
indexApp.controller('homeController', function ($scope, $http, $localStorage) {
    ...
    $http({
        method: "POST",
        url: protocol+"://"+ipserver+"/api/users",
...
indexApp.controller('gestisciLogin', function ($scope, $http, $location, $localStorage) {
    ...
    if (curToken.enable == true) {
        $http({
            method: "POST",
            url: protocol+"://"+ipserver+"/api", //  ########################################################## non so cosa sia.
            headers: { 'Content-Type': 'application/json' },
    ...
    $scope.login = function () {
        ...
        $http({
            method: "POST",
            url: protocol+"://"+ipserver+"/api/authenticate",
            headers: { 'Content-Type': 'application/json' },
            data: parametri
        }).then(function (response) {
            if (response.data.success) {
...
indexApp.controller("gestisciSingup", function ($scope, $http, $location, $localStorage) {
    ...
    $scope.registra = function () {
        ...
        $http({
            method: "POST",
            url: protocol+"://"+ipserver+"/api/singup",
            headers: { 'Content-Type': 'application/json' },
            data: parametri
        }).then(function (response) {
            if (response.data.success) {
...
indexApp.controller("gestisciScreen", function ($scope, $http, $window, $localStorage, Upload) {
    ...
    $http({
        method: "POST",
        url: protocol+"://"+ipserver+"/api/getScreen",
        headers: { 'Content-Type': 'application/json' },
        data: parametri
    }).then(function (response) {
        if (response.data.success) {
    ...
    $scope.plusOne = function (index) {
        ...
        $http({
            method: "POST",
            url: protocol+"://"+ipserver+"/api/votaScreen",
            headers: { 'Content-Type': 'application/json' },
            data: parametri
        }).then(function (response) {
            if (response.data.success) {
    ...
    $scope.sendScreen = function () {
        ...
        Upload.upload({
            url: protocol+"://"+ipserver+"/api/uploadScreen",
            method: 'POST',
            data: {
                titolo: $scope.titolo,
